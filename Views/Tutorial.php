...
<html>
    ...
    <body class="bg-gray-100 w-full">    
        <div class="w-full flex">
          <div class="">
            <aside class="w-[220px]" style="width:220px;">
              <div class="bg-gray-200">
                <div class="flex flex-col sm:flex-row sm:justify-around">
                    <div class="w-full h-screen bg-white border-2 border-gray-100">
                        ...
                        <nav class="mt-10">
                            <?php if($DataReady){                            
                                foreach($sections as $section){ 
                                    ...
                                    <a onclick="loadContent(<?php echo $section->Id ?>, <?php echo $tutorialId ?>)" class="flex items-center py-2 px-8 border-solid border-black border-b-2 text-gray-700 border-r-4 border-gray-700" href="#">
                                            <span class="mx-4 font-medium"><?php echo $section->Title ?></span>
                                        </a>
                                <?php
                                 }
                                }
          ...
          <div class=" ml-9 my-5 w-full">
            ...
            <section class="w-full px-6 py-8 mx-auto bg-white dark:bg-gray-900">
                ...
                <!-- The main content -->
                <?php if($DataReady) { ?>
                    <main class="mt-8 p-6" id="mainContent" >
                        <h1 class="text-4xl bg-green-100"><?php echo "Hello wourld" ?></h1>
                    </main>
                <?php } ?>
        ...
        <script>
            function loadContent(sectionsid,tutorialid){
                //window.alert("section : "+sectionsid+" --------- tutorialid : "+ tutorialid)
