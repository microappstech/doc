...
<hr class="border-gray-200 sm:mx-auto dark:border-gray-700 ">
	...
	<footer class="p-4 bg-white sm:p-6 light:bg-gray-800">
		...
		<div class="sm:flex sm:items-center sm:justify-between">
			<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://hamza-mouddakir.tech" target="_blank" class="hover:underline">Hamza mouddakir</a>. All Rights Reserved.
</span>
